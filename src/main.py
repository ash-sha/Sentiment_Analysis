...
amazon_data_path = os.getenv('AMAZON_DATA_PATH', '/MLOps/1.Sentiment_Analysis/data/test_amazon.csv')
amazon_test_path = os.getenv('AMAZON_TEST_PATH', '/MLOps/1.Sentiment_Analysis/data/test_amazon.csv')
movie_data_path = os.getenv('MOVIE_DATA_PATH', '/MLOps/1.Sentiment_Analysis/data/train.csv')
